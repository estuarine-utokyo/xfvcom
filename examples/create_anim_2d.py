...
def anim(nprocs=16, var_name=None, siglay=0, plot_kwargs=None, plotter=None, fps=10,
    ...
    """
    create_anim_2d_plot(plotter=plotter, processes=nprocs, var_name=var_name, siglay=siglay, fps=fps,
                        generate_gif=generate_gif, generate_mp4=generate_mp4, cleanup=cleanup,
                        post_process_func=post_process_func, plot_kwargs=plot_kwargs)
...
var_names = ["temp", "salinity", "O2_o", "N1_p", "N3_n", "N4_n", "N5_s", "P1_Chl", "P2_Chl", "P3_Chl", "P4_Chl"]
var_names = ["O2_o"]
...
for siglay in siglays:
    for var_name in var_names:
        anim(nprocs=nprocs, var_name=var_name, siglay=siglay, plot_kwargs=plot_kwargs_dict[var_name],
             plotter=plotter, fps=fps)
