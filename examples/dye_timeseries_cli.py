#!/usr/bin/env python3
"""CLI for extracting multi-year dye time series from FVCOM outputs.

This script provides a command-line interface to the xfvcom.dye_timeseries
module for robust extraction and analysis of dye concentration time series.

Examples:
    # Basic extraction
    python dye_timeseries_cli.py --years 2021 --members 0 1 2 --nodes 123,456 --sigmas 0,1

    # With linearity check and output
    python dye_timeseries_cli.py --years 2021 2022 --members 0 1 18 \\
        --nodes 123 --sigmas 0 --verify-linearity --ref-member 0 --parts 1 18 \\
        --save output/dye_series.nc

    # Climatology mode
    python dye_timeseries_cli.py --years 2020 2021 2022 --members 0 1 2 \\
