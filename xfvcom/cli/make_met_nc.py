...
""",
    ...
    gap_group.add_argument(
        ...
        type=Path,
        metavar="PATH",
        help="YAML file with pre-computed station correlations (overrides auto-cache)",
    )
    gap_group.add_argument(
    ...
    gap_group.add_argument(
        ...
        action="store_true",
        help="Disable auto-caching of correlations",
    )
    gap_group.add_argument(
        "--solar-model",
    ...
    if args.correlation_file:
        # Explicit file overrides auto-cache
    ...
    elif args.fill_gaps and fallback_stations and args.gwo_dir:
        # Auto-cache correlations when gap filling with fallback stations
        ...
        correlations = get_cached_correlations(
            ...
            recompute=args.recompute_correlations,
            use_cache=not args.no_correlation_cache,
        )
